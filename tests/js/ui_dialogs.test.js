...
describe('dialogs', () => {
  test('confirm dialog resolves true on confirm', async () => {
    ...
    const confirmButton = document.querySelector('.sugarcubes-confirm__confirm');
  ...
  test('input modal resolves trimmed values and blocks invalid submit', async () => {
    ...
    const input = document.querySelector('.sugarcubes-input-dialog input');
    const confirmButton = document.querySelector('.sugarcubes-input-dialog button:last-child');
  ...
  test('form modal validates required fields and returns values', async () => {
    ...
    const inputs = document.querySelectorAll('.sugarcubes-form-dialog input');
  ...
  test('selection modal requires a selection and resolves the selected item', async () => {
    ...
    const confirmButton = document.querySelector('.sugarcubes-selection-dialog button:last-child');
    expect(confirmButton.disabled).toBe(true);

    const radio = document.querySelector('.sugarcubes-selection-dialog input[value="cinematic"]');
    radio.checked = true;
  ...
  test('confirm dialog renders markup-like text literally', async () => {
    ...
    const paragraphs = Array.from(
      document.querySelectorAll('.sugarcubes-confirm__message p'),
  ...
  test('modal service alert uses SugarCubes modal without a cancel button', async () => {
    ...
    const dialog = document.querySelector('.sugarcubes-confirm-dialog');
  ...
  test('modal service historical save choice resolves fork and renders text literally', async () => {
    ...
    const dialog = document.querySelector('.sugarcubes-historical-save-dialog');
  ...
  test('version dialog persists dismissal', async () => {
    ...
    const checkbox = document.querySelector('.sugarcubes-version-dialog__dismiss input');
    const confirmButton = document.querySelector('.sugarcubes-version-dialog button:last-child');
