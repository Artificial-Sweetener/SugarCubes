...
import type { PlacementAdapter, PlacementScheduler, PlacementState } from './PlacementOverlay.js';
import type { PlacementPointerController } from './PlacementPointerController.js';

interface DomOptions {
  adapter: PlacementAdapter | null;
  scheduler: PlacementScheduler | null;
  state: PlacementState;
  pointer: PlacementPointerController;
  setDirty: () => void;
