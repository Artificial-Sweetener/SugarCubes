...
import type { PlacementAdapter, PlacementCanvas, PlacementState } from './PlacementOverlay.js';

interface PointerOptions {
  adapter: PlacementAdapter | null;
  state: PlacementState;
  logger: { warn(...values: unknown[]): void } | null;
  commit: () => Promise<void>;
...
export class PlacementPointerController {
  ...
  private readonly logger: PointerOptions['logger'];
  ...
  getCanvas(): PlacementCanvas | null {
