...
interface CommandOptions {
  ...
  applyPreparedImport: PlacementOverlayOptions['applyPreparedImport'];
  reportImportOutcome: PlacementOverlayOptions['reportImportOutcome'];
  buildShiftedPlacementPayload: PlacementOverlayOptions['buildShiftedPlacementPayload'];
  stop: (reason?: string | null) => void;
  computeDropOrigin: () => Vec2;
  installPlacementHandlers: () => boolean;
  setPlacementSidebarVisibility: (active: boolean) => void;
  setDirty: () => void;
}
