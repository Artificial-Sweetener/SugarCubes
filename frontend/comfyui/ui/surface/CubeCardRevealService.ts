...
import { requireCubeSurface, type CubeNode } from '../cube/node/ComfyCubeNodeFactory.js';
...
export class CubeCardRevealService {
  ...
  setRevealed(node: CubeNode, nodeId: string, revealed: boolean): void {
    const internalNode = node.subgraph._nodes.find(
