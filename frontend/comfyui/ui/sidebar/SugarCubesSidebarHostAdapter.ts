...
export interface SugarCubesSidebarManager {
...
export interface EmbeddedCubeBrowser {
  mountEmbedded(container: HTMLElement): void;
}

export interface SugarCubesSidebarHostAdapterOptions {
  document: Document;
  getManager(): SugarCubesSidebarManager | null | undefined;
  browser: EmbeddedCubeBrowser;
...
export class SugarCubesSidebarHostAdapter {
  ...
  readonly #getManager: () => SugarCubesSidebarManager | null | undefined;
  readonly #browser: EmbeddedCubeBrowser;
  readonly #logger: Pick<Console, 'warn'>;
  #registeredManager: SugarCubesSidebarManager | null = null;
  #root: HTMLDivElement | null = null;

  /** Bind the host manager and embedded Cube browser. */
  constructor(options: SugarCubesSidebarHostAdapterOptions) {
  ...
  register(): void {
    ...
    if (this.#registeredManager === manager) return;
    this.#root = null;
