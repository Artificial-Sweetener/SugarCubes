...
import type { CubeSurface, SurfaceControl } from '../types/graph.js';
import { isRecord } from '../types/common.js';
import type { UnknownRecord } from '../types/common.js';

function readControlString(control: unknown, key: string): string {
 ...
 */
export function isVolatileSeedControl(control: unknown): boolean {
 ...
 */
export function trackedSurfaceControls(surface: CubeSurface | null | undefined): SurfaceControl[] {
 ...
 */
export function filterTrackedSurfaceValues(
