...
import type { Bounds, Vec2 } from '../types/common.js';
import { isRecord } from '../types/common.js';

function isNumericSequence(value: unknown, minimumLength: number): value is ArrayLike<number> {
 ...
 * Read node bounds.
 */
export function readNodeBounds(node: unknown): Bounds | null {
 ...
 * Read group bounds.
 */
export function readGroupBounds(group: unknown): Bounds | null {
 ...
 * Get node center.
 */
export function getNodeCenter(node: unknown): Vec2 | null {
