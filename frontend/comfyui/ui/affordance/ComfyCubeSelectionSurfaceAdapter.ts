...
import type { ComfyCubeSelectionMenuVisibilityAdapter } from './ComfyCubeSelectionMenuVisibilityAdapter.js';
import type { ComfyCubeSelectionToolboxAdapter } from './ComfyCubeSelectionToolboxAdapter.js';
...
export class ComfyCubeSelectionSurfaceAdapter {
  ...
  readonly #toolbox: ComfyCubeSelectionToolboxAdapter;
  readonly #menus: ComfyCubeSelectionMenuVisibilityAdapter;
  ...
  constructor(options: {
    ...
    toolbox: ComfyCubeSelectionToolboxAdapter;
    menus: ComfyCubeSelectionMenuVisibilityAdapter;
  }) {
