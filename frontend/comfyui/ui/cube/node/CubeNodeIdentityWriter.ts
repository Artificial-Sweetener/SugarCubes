...
export function updateCubeNodeIdentityForIds(
  catalog: CubeNodeCatalog,
  instanceIds: readonly string[],
  updates: CubeNodeIdentityUpdates,
): number {
...
function applyUpdates(current: UnknownRecord, updates: CubeNodeIdentityUpdates): UnknownRecord {
  return {
    ...current,
