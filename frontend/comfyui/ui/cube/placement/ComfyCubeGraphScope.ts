...
export class ComfyCubeGraphScope {
  ...
  readonly #getCurrentGraph: () => unknown;

  /** Bind the validated workflow root and dynamic active graph resolver. */
  constructor(rootGraph: object, getCurrentGraph: () => unknown) {
