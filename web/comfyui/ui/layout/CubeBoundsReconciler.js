...
function payloadEqual(a, b) {
  ...
  return (
    ...
    a.w === b.w &&
    a.h === b.h &&
    (a.padding?.x ?? null) === (b.padding?.x ?? null) &&
    (a.padding?.y ?? null) === (b.padding?.y ?? null) &&
    (a.padding?.top_extra ?? null) === (b.padding?.top_extra ?? null) &&
    (a.header?.height ?? null) === (b.header?.height ?? null)
  );
}
...
export class CubeBoundsReconciler {
  ...
  reconcileAll({ graph, index } = {}) {
    ...
    for (const instance of instances) {
      const canonicalSource = instance.metadata?.bounds || instance.bounds || null;
      const canonicalRaw =
