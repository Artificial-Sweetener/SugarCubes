    ...
    #drawPreview(context, preview, item) {
        ...
        for (const output of outputSections) {
            ...
            for (const previewItem of output.items) {
                ...
                const target = fitCubePreviewImage(image.naturalWidth, image.naturalHeight, previewItem.rect.x, previewItem.rect.y, previewItem.rect.width, previewItem.rect.height);
