...
export class ComfyLiteGraphCubeDomWidgetHost {
    ...
    constructor(options) {
        ...
        this.#promptSizing = new CubePromptDomWidgetSizingHost(options.document, options.onGeometryChange ?? (() => undefined));
    }
    ...
    #restore(mounted) {
        ...
        if (origin.parent) {
            const insertionPoint = origin.nextSibling?.parentNode === origin.parent ? origin.nextSibling : null;
...
function finiteVectorValue(value, index) {
