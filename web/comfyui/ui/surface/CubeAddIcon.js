...
export function createCubeAddIconElement(documentRef) {
...
function ensureCubeAddIconStyles(documentRef) {
...
export function drawCubeAddIcon(context, centerX, centerY, backgroundColor) {
