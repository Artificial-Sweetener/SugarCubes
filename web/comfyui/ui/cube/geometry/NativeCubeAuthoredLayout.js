...
import { readAuthoredLayoutBaseline, readPayloadAuthoredLayoutBaseline, } from '../../geometry/AuthoredLayoutBaseline.js';
...
export function attachNativeCubeAuthoredLayout(subgraph, payload) {
...
export function readNativeCubeAuthoredLayout(subgraph) {
    if (!isRecord(subgraph.extra))
        return null;
