...
export function mapLegacyCubeIdentity(plan) {
    ...
    const defaultAlias = readString(definition.default_alias) || readString(metadata.default_alias) || plan.title;
    return {
        cubeId: plan.cubeId || readString(definition.cube_id) || readString(metadata.cube_id),
        cubeVersion: plan.cubeVersion || readString(definition.cube_version) || readString(metadata.cube_version),
        instanceId: plan.key,
        defaultAlias,
        instanceAlias: readString(instance.instance_alias) ||
