...
export class BaselineStore {
  private readonly definitionImplementationHashByCubeId: Map<string, string>;
  private readonly definitionStatusByCubeId: Map<string, string>;
  private readonly localImplementationHashByInstanceId: Map<string, string>;
  private readonly localCosmeticHashByInstanceId: Map<string, string>;
  ...
  setDefinition(cubeId: string | null | undefined, entry: unknown = {}): void {
    if (!cubeId) {
      return;
    }
    const definition = entry && typeof entry === 'object' ? (entry as Record<string, unknown>) : {};
  ...
  getDefinitionHash(cubeId: string | null | undefined): string | null {
    if (!cubeId) {
      return null;
    }
  ...
  getDefinitionStatus(cubeId: string | null | undefined): string | null {
    if (!cubeId) {
      return null;
    }
  ...
  setLocalBaselineHash(instanceId: string | null | undefined, hash: unknown): void {
    this.setLocalImplementationHash(instanceId, hash);
  }

  getLocalBaselineHash(instanceId: string | null | undefined): string | null {
    return this.getLocalImplementationHash(instanceId);
  }

  clearLocalBaseline(instanceId: string | null | undefined): void {
    this.clearLocalImplementationHash(instanceId);
  }

  setLocalImplementationHash(instanceId: string | null | undefined, hash: unknown): void {
    if (!instanceId) {
      return;
    }
  ...
  getLocalImplementationHash(instanceId: string | null | undefined): string | null {
    if (!instanceId) {
      return null;
    }
  ...
  clearLocalImplementationHash(instanceId: string | null | undefined): void {
    if (!instanceId) {
      return;
    }
    this.localImplementationHashByInstanceId.delete(instanceId);
  ...
  setLocalCosmeticHash(instanceId: string | null | undefined, hash: unknown): void {
    if (!instanceId) {
      return;
    }
    if (typeof hash === 'string' && hash) {
  ...
  getLocalCosmeticHash(instanceId: string | null | undefined): string | null {
    if (!instanceId) {
      return null;
    }
  ...
  clearLocalCosmeticHash(instanceId: string | null | undefined): void {
    if (!instanceId) {
      return;
    }
    this.localCosmeticHashByInstanceId.delete(instanceId);
  ...
  pruneLocalBaselines(activeInstanceIds: Set<string> | null | undefined): void {
