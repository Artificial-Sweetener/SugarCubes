...
export interface CubeMarkerUpdates {
  cubeId?: string;
  defaultAlias?: string;
  instanceAlias?: string;
  instanceId?: string;
  cubeVersion?: unknown;
  cubeRevisionRef?: unknown;
}
...
function normalizeUpdateString(value: unknown): string {
 ...
 */
export const CUBE_MARKER_KINDS: Readonly<Record<string, 'input' | 'output'>> = Object.freeze({
 ...
 */
export function isCubeMarkerType(node: ComfyNode | null | undefined): boolean {
  return Boolean(node?.type && CUBE_MARKER_KINDS[node.type]);
}

/**
 * Read cube marker default alias.
 */
export function readCubeMarkerDefaultAlias(node: ComfyNode | null | undefined): string {
 ...
 * Read cube marker id.
 */
export function readCubeMarkerId(node: ComfyNode | null | undefined): string {
 ...
 */
export function readCubeMarkerInstanceId(node: ComfyNode | null | undefined): string {
 ...
 */
export function readCubeMarkerInstanceAlias(node: ComfyNode | null | undefined): string {
 ...
 */
export function readCubeMarkerVersion(node: ComfyNode | null | undefined): string {
  const propertyValue =
 ...
 */
export function readCubeMarkerRevisionRef(node: ComfyNode | null | undefined): string {
  const propertyValue =
 ...
 */
export function writeCubeMarkerInstanceId(
 ...
 */
export function writeCubeMarkerInstanceAlias(
  node: ComfyNode | null | undefined,
 ...
 */
export function updateMarkersForCubeId(
  graph: ComfyGraph | null | undefined,
  cubeId: string,
  updates: CubeMarkerUpdates | null | undefined,
): number {
 ...
 */
export function updateMarkersForIds(
  graph: ComfyGraph | null | undefined,
  markerIds: GraphId | readonly GraphId[],
  updates: CubeMarkerUpdates | null | undefined,
): number {
  if (!graph || !updates) {
    return 0;
