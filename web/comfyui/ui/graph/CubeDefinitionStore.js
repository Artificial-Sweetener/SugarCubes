...
export class CubeDefinitionStore {
    ...
    onUpdate;
    entries;
    constructor({ api = null, logger = null, ttlMs, onUpdate = null } = {}) {
        this.api = api;
        this.logger = logger;
...
export function resolveDefinitionRequest(request) {
    ...
    const definitionKey = typeof request?.definitionKey === 'string' && request.definitionKey.trim()
