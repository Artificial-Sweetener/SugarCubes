...
import { resolveCubeDisplayName, resolveInstanceDisplayName, getGroupSugarcubes, } from '../graph/GroupMetadata.js';
import { readGroupBounds } from '../graph/Bounds.js';
import { clampNumber, resolveGroupFontFamily, resolveGroupTitleColor, resolveGroupTitlePadding, } from './CubeChromeLayout.js';
/** Paint reusable Cube chrome canvas primitives. */
export class CubeChromePainter {
    paintCubeIcon;
    iconResolver;
    constructor(requestRedraw, paintCubeIcon) {
        this.paintCubeIcon = paintCubeIcon;
