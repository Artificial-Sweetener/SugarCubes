...
import { CHROME_BADGE_MAX_WIDTH, CHROME_BADGE_MIN_WIDTH, CHROME_BUTTONS, buildStackedBadgeLayout, clampNumber, computeCenteredBadgeSlot, computePillLayout, hasSwapEligibility, removeUnpinnedPillEntry, resolveGroupFontFamily, resolveGroupTitleColor, resolveGroupTitlePadding, sumPillWidths, triadicColor, } from './CubeChromeLayout.js';
...
export class CubeChromeRenderer {
    options;
    animationState = new CubeChromeAnimationState();
    resolveSource;
    painter;
    contentPainter;
    hitRegions = [];
    ...
    isHovered(instanceId, key) {
        ...
        if (!hover.hoveredKey || hover.hoveredKey !== key)
            return false;
