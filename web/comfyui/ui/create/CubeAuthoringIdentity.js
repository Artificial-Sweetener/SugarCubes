...
export function suggestCubeAuthoringIdentity(name, targetModel, destination, existingCubeIds = []) {
    ...
    const usedIds = new Set(existingCubeIds
...
function buildCubeId(name, targetModel, destination) {
